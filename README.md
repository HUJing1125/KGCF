...
Step 3, run trainfb.py generate ./trainmodelmovie/neighbor_dict.pkl best_model.pt checkpoint.pt relaton_to_id.json

step 4, run testfb.py generate ./trainmodelmovie/test_results.json

### WN18RR dataset

Step 1, run preprocess2.py generate ./WN18RR/node_info.json

Step 2, run OSE.py generate WN_embedding.h5

Step 3, run trainwn.py generate ./trainmodel/neighbor_dict.pkl best_model.pt checkpoint.pt relaton_to_id.json

step 4, run testwn.py generate ./trainmodel/test_results.json
